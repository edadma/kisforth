...
static void f_fdrop(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
  float_pop(ctx);
}
...
static void f_fdup(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
...
static void f_fplus(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
...
static void f_fminus(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
  double r2 = float_pop(ctx);
  double r1 = float_pop(ctx);
...
static void f_fmultiply(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
  double r2 = float_pop(ctx);
  double r1 = float_pop(ctx);
...
static void f_fdivide(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
  double r2 = float_pop(ctx);
  double r1 = float_pop(ctx);
...
static void f_fdot(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
...
static void f_flit(context_t* ctx, word_t* self) {
  (void)ctx;
  (void)self;
