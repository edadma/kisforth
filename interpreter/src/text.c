...
void set_current_to_in(cell_t value) { forth_store(to_in_addr, value); }
...
cell_t get_current_to_in(void) { return forth_fetch(to_in_addr); }

cell_t get_current_input_length(void) { return forth_fetch(input_length_addr); }
